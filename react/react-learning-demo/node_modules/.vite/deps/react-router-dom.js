...
function matchRoutesImpl(routes, locationArg, basename, allowPartial, precomputedBranches) {
  ...
  let branches = precomputedBranches != null ? precomputedBranches : flattenAndRankRoutes(routes);
  let matches = null;
...
function matchRouteBranch(branch, pathname, allowPartial = false) {
  ...
  for (let i = 0; i < routesMeta.length; ++i) {
    ...
    let match = meta.matcher && meta.compiledParams ? matchPathImpl(
      pattern,
      remainingPathname,
      meta.matcher,
      meta.compiledParams
...
var DataRoutes = class {
  ...
  get activeRoutes() {
    var _a;
    return (_a = __privateGet(this, _hmrRoutes)) != null ? _a : __privateGet(this, _routes);
  }
  get branches() {
    var _a;
    return (_a = __privateGet(this, _hmrBranches)) != null ? _a : __privateGet(this, _branches);
  }
  get hasHMRRoutes() {
...
function createRouter(init) {
  ...
  function updateState(newState, opts = {}) {
    ...
    if (subscribers.size === 0) {
      bufferedInitialStateUpdate = { newErrors: (_a = newState.errors) != null ? _a : null };
    }
    [...subscribers].forEach(
      (subscriber) => {
        var _a2;
        return subscriber(state, {
          ...
          newErrors: (_a2 = newState.errors) != null ? _a2 : null,
  ...
  async function navigate(to, opts) {
    ...
    if (opts == null ? void 0 : opts.mask) {
      ...
      maskPath = {
        pathname: (_a = partialPath.pathname) != null ? _a : "",
        search: (_b = partialPath.search) != null ? _b : "",
        hash: (_c = partialPath.hash) != null ? _c : ""
      };
  ...
  async function startNavigation(historyAction, location2, opts) {
    ...
    let matches = (opts == null ? void 0 : opts.initialHydration) && state.matches && state.matches.length > 0 && !initialMatchesIsFOW ? state.matches : matchRoutesImpl(
      routesToUse,
      location2,
      basename,
      false,
...
function useParams() {
  ...
  return (_a = routeMatch == null ? void 0 : routeMatch.params) != null ? _a : {};
}
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
  ...
  let matches = dataRouterOpts && dataRouterOpts.state.matches.length ? dataRouterOpts.state.matches.map(
    (m) => Object.assign(m, {
...
function useRouterState() {
  ...
  let active = React2.useMemo(
    () => {
      ...
      return {
        ...
        params: (_b = (_a = matches[matches.length - 1]) == null ? void 0 : _a.params) != null ? _b : {},
  ...
  let pending = React2.useMemo(() => {
    ...
    let shared = {
      ...
      params: (_b = (_a = navigation.matches[navigation.matches.length - 1]) == null ? void 0 : _a.params) != null ? _b : {},
...
function encode(input, options) {
  const { onComplete, plugins, postPlugins, signal } = options != null ? options : {};
  const encoder3 = {
    deferred: {},
    index: 0,
    ...
    plugins: [
      (type, ...rest) => {
        if (type === "SanitizedError") {
          ...
          if (name && SUPPORTED_ERROR_TYPES.includes(name) && name in global2 && typeof global2[name] === "function") {
...
try {
  if (isBrowser2) {
    window.__reactRouterVersion = "7.18.3";
  }
} catch (e) {
}
...
async function routeRSCServerRequest({
  ...
  try {
    ...
    try {
      let normalizedError = renderError != null ? renderError : error;
